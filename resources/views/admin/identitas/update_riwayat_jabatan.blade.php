<div id="modal-edit-rjabatan" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            if ($user->level == 1) {
            ?>
                <form action="{{ url('admin/pegawai-admin/rjabatan/update') }}" method="POST" enctype="multipart/form-data">
                <?php
            } else { ?>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="grid grid-cols-12 gap-2">
                            ...
                            <div class="form-inline mt-4 col-span-5">
                                <input name="no_rek" type="number" class="form-control ubah_rjabatan_no_rek" placeholder="Nomor Rekening Pembayaran Gaji" required>
                            </div>
                            <div class="form-inline mt-4 col-span-2">
                                <label for="gaji" class="form-label">*Nominal Gaji</label>
                            </div>
                            <div class="form-inline mt-4 col-span-3">
                                <input name="gaji" type="number" class="form-control ubah_rjabatan_gaji" placeholder="Nominal Gaji" required>
                            </div>
                        </div>
                        <div class="grid grid-cols-12 gap-2">
                            <div class="form-inline mt-4 col-span-2">
