<div id="modal-edit-identitas" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            if ($user->level == 1) {
            ?>
                <form action="{{ url('/admin/pegawai-admin/update') }}" method="POST" enctype="multipart/form-data">
                <?php
            } else { ?>
                    ...
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                        ...
                        <div class="col-span-12 sm:col-span-12">
                            ...
                            <input name="nik" type="number" class="form-control ubah_nik" placeholder="NIK KTP" readonly>
                        </div>
                        <div class="col-span-12 sm:col-span-12">
